	...
	return (
		<>
			...
			<main className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
				...
				{/* Call to Action */}
				<section className="bg-primary text-white rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
					...
					<p className="text-white/90 max-w-xl mx-auto mb-10 text-lg relative z-10">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
						<Link
							href="/auth/signup"
							className="bg-white text-primary px-8 py-4 rounded-xl font-bold shadow-lg shadow-black/10 hover:bg-white/95 hover:scale-105 transition-all text-sm md:text-base uppercase tracking-wide"
						>
							Apply to Join a Team
						</Link>
						<button className="bg-transparent border border-white/60 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/10 transition-all text-sm md:text-base uppercase tracking-wide">
